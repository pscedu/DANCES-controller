...
class PSCSwitch13(app_manager.RyuApp):
	...
	def send_psc_test_config(self, datapath):
		...
		self.add_goto_to_table(datapath, 0, 10, 20)
	...
	##	self.add_flow(datapath, 1, match, actions)
		...
		actions = [parser.OFPActionOutput(34), parser.OFPActionSetField(vlan_vid=(0x1000 | 4011)), parser.OFPActionSetQueue(0)]
		...
		actions = [parser.OFPActionOutput(17), parser.OFPActionSetField(vlan_vid=(0x1000 | 4004)), parser.OFPActionSetQueue(0)]
	...
	##	self.add_flow(datapath, 1, match, actions)
		...
		actions = [parser.OFPActionOutput(33), parser.OFPActionSetField(vlan_vid=(0x1000 | 4011)), parser.OFPActionSetQueue(0)]
		self.add_flow(datapath, 100, l3Table, match, actions)
		#
		# vlan 4011 -> remote path
		match = parser.OFPMatch(eth_type=0x0800, ipv4_dst="147.73.7.99", vlan_vid=(0x1000 | 4011))
		actions = [parser.OFPActionOutput(17), parser.OFPActionSetField(vlan_vid=(0x1000 | 4003)), parser.OFPActionSetQueue(0)]
		self.add_flow(datapath, 90, l3Table, match, actions)
		#
		...
		actions = [parser.OFPActionOutput(18), parser.OFPActionSetField(vlan_vid=(0x1000 | 4010)), parser.OFPActionSetQueue(0)]
		self.add_flow(datapath, 100, l3Table, match, actions)
		# vlan 4010 -> local path
		...
		actions = [parser.OFPActionOutput(34), parser.OFPActionSetField(vlan_vid=(0x1000 | 4011)), parser.OFPActionSetQueue(1)]
		...
		actions = [parser.OFPActionOutput(17), parser.OFPActionSetField(vlan_vid=(0x1000 | 4004)), parser.OFPActionSetQueue(1)]
		...
		actions = [parser.OFPActionOutput(33), parser.OFPActionSetField(vlan_vid=(0x1000 | 4011)), parser.OFPActionSetQueue(1)]
		self.add_flow(datapath, 100, dscpTable, match, actions)
		#
		# vlan 4011 -> remote path
		match = parser.OFPMatch(eth_type=0x0800, ipv4_dst="147.73.7.99", vlan_vid=(0x1000 | 4011), ip_dscp=22)
		actions = [parser.OFPActionOutput(17), parser.OFPActionSetField(vlan_vid=(0x1000 | 4003)), parser.OFPActionSetQueue(1)]
		self.add_flow(datapath, 90, dscpTable, match, actions)
		#
		# vlan 4004 -> local path
		...
		actions = [parser.OFPActionOutput(18), parser.OFPActionSetField(vlan_vid=(0x1000 | 4010)), parser.OFPActionSetQueue(1)]
		self.add_flow(datapath, 100, dscpTable, match, actions)
		# vlan 4010 -> local path
