...
class PSCSwitch13(app_manager.RyuApp):
	...
	##	self.add_flow(datapath, 1, match, actions)
		...
		actions = [parser.OFPActionOutput(1), parser.OFPActionSetField(vlan_vid=(0x1000 | 4011)), parser.OFPActionSetQueue(1)]
		self.add_flow(datapath, prio_low, l3Table, match, actions)
		#
		# vlan 4011 -> remote path
		match = parser.OFPMatch(eth_type=0x0800, ipv4_dst="147.73.7.101", vlan_vid=(0x1000 | 4011))
		actions = [parser.OFPActionOutput(14), parser.OFPActionSetField(vlan_vid=(0x1000 | 4004)), parser.OFPActionSetQueue(1)]
		self.add_flow(datapath, prio_low, l3Table, match, actions)
		#
	...
	##	self.add_flow(datapath, 1, match, actions)
		...
		actions = [parser.OFPActionOutput(2), parser.OFPActionSetField(vlan_vid=(0x1000 | 4011)), parser.OFPActionSetQueue(2)]
		self.add_flow(datapath, prio_low, l3Table, match, actions)
		#
		# vlan 4011 -> remote path
		match = parser.OFPMatch(eth_type=0x0800, ipv4_dst="147.73.7.99", vlan_vid=(0x1000 | 4011))
		actions = [parser.OFPActionOutput(14), parser.OFPActionSetField(vlan_vid=(0x1000 | 4003)), parser.OFPActionSetQueue(2)]
		self.add_flow(datapath, prio_low, l3Table, match, actions)
		#
		...
		actions = [parser.OFPActionOutput(13), parser.OFPActionSetField(vlan_vid=(0x1000 | 4010)), parser.OFPActionSetQueue(3)]
		self.add_flow(datapath, prio_low, l3Table, match, actions)
		# vlan 4010 -> local path
		...
		self.add_metered_flow(datapath, prio_high, dscpTable, match, actions, 1)
		#
		# vlan 4011 -> remote path
		...
		self.add_metered_flow(datapath, prio_high, dscpTable, match, actions, 2)
		#
		# vlan 4003 -> local path
		match = parser.OFPMatch(eth_type=0x0800, ipv4_dst="147.73.7.101", vlan_vid=(0x1000 | 4003), ip_dscp=22)
		actions = [parser.OFPActionOutput(1), parser.OFPActionSetField(vlan_vid=(0x1000 | 4011)), parser.OFPActionSetQueue(7)]
		self.add_flow(datapath, prio_high, dscpTable, match, actions)
